...
from .models import Product, CartItem, Transaction, LineItem, Transaction
...
def transaction_history(request):
    transactions = Transaction.objects.filter(user=request.user).prefetch_related('lineitem_set')
    context = {
